...
class VisitConfirmationMail extends Mailable
{
    ...
    {
        $subject = 'Programmation de visite';
        ...
        <body>
            <h1>Programmation de visite</h1>
            <p>Bonjour  ' . $this->name. ',</p>
            <p>Nous vous écrivons pour vous confirmer que votre visite est bien programmée sur la date du  ' . $this->date . ' à  ' .$this->time . ' .</p>
