    ...
    <div class="container">
        <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
            ...
            <div class="col-12 position-relative mb-30px">
                <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <!-- Images du carrousel -->
                        @if($post && $post->images && $post->images->isNotEmpty())
                            @foreach($post->images as $index => $image)
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                    <img src="{{ Storage::disk('public')->url($image->path)}} " class="d-block w-100" alt="Image">
                                </div>
                            @endforeach
                            @else
                            <div class="carousel-item active"> <!-- Image par défaut si aucune image n'est disponible -->
                                <img src="{{ asset('images/default-image.jpg') }}" class="d-block w-100" alt="Image par défaut">
                            </div>
                        @endif
                    </div>
            ...
            <div class="col-lg-3 offset-xl-2 offset-lg-1 border-start border-2 border-color-base-color ps-40px sm-ps-25px md-mb-auto">
                <h4 class="text-dark-gray fw-700 alt-font mb-5px">$ {{ number_format($post?->prix, 0, '.', ',') }}</h4>
                <span class="fw-500 fs-18">${{ number_format($post?->prix, 0, '.', ',') .'/'. $post?->surface }} - Per sq. ft.</span>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
            <div class="col text-center border-end xs-border-end-0 border-color-extra-medium-gray alt-font md-mb-15px">
                <span class="fs-19 text-dark-gray fw-600">Property size:</span> {{ $post?->surface }} sq ft
            </div>
            <div class="col text-center border-end md-border-end-0 border-color-extra-medium-gray alt-font md-mb-15px">
                <span class="fs-19 text-dark-gray fw-600">Year built:</span> {{ $post?->created_at->format('Y') }}
            </div>
            <div class="col text-center border-end xs-border-end-0 border-color-extra-medium-gray alt-font sm-mb-15px">
                <span class="fs-19 text-dark-gray fw-600">Accommodation:</span> {{ $post?->draft ? 'Furnished' : 'Not Furnished' }}
            </div>
            <div class="col text-center alt-font">
                <span class="fs-19 text-dark-gray fw-600">Heating:</span> {{ $post?->draft ? 'TA furnace' : 'Unknown' }}
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="ps-45px pe-45px pt-35px pb-45px xs-p-25px contact-form-style-01 mt-0">
                        <div class="mb-20px last-paragraph-no-margin">
                            <p class="mb-0 alt-font fw-500 text-dark-gray">
                                ...
                                <a href="tel:{{ $post?->user?->phone }}" class="text-dark-gray text-base-color-hover">{{ $post?->user?->phone }}</a>
                            </p>
                            <p class="alt-font fw-500 text-dark-gray">
                                ...
                                <a href="mailto:{{ $post?->user?->email }}" class="text-dark-gray text-decoration-line-bottom">{{ $post?->user?->email }}</a>
                            </p>
                        </div>
